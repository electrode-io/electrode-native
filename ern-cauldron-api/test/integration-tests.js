...
import start, { CauldronHelper, getCauldron, setCauldron } from '../api.js';
...
describe('NativeApps', () => {
  before((done) => {
    start({
      nativeBinariesStorePath: './.cauldron-test/binaries',
      sourceMapsStorePath: './.cauldron-test/sourcemaps',
      dbFilePath: './.cauldron-test/db.json'
    });
    done();
  });
