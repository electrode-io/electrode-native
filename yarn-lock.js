...
let yarnLock = fs.readFileSync('yarn.lock', 'utf8')
let yarnLockParsed = lockfile.parse(yarnLock)
...
if (yarnLockParsed && yarnLockParsed.object) {
  ...
  if (incorrectRegistries.length > 0) {
    console.log(chalk.bold.red('yarn.lock contains registry other than https://registry.yarnpkg.com'))
