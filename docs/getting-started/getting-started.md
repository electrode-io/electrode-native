...
```bash
$ ern run-android --miniapps moviedetailsminiapp@0.0.29 --mainMiniAppName MovieListMiniApp
```  
...
$ ern run-ios --miniapps moviedetailsminiapp@0.0.29 --mainMiniAppName MovieListMiniApp
```  
