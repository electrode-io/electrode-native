...
```bash
$ ern run-android --miniapps moviedetailsminiapp@0.0.23 --mainMiniAppName MovieListMiniApp
```  
...
$ ern run-ios --miniapps moviedetailsminiapp@0.0.23 --mainMiniAppName MovieListMiniApp
```  
