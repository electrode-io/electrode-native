...
[**imageUploaded**](PetApi.md#imageUploaded) | **EVENT** /pet/imageUploaded | uploads an image
...
```java
// Import classes:
//import com.walmartlabs.ern.api.PetApi;
...
try {
    apiInstance.imageUploaded(petId);
} catch (ApiException e) {
    System.err.println("Exception when calling PetApi#imageUploaded");
    e.printStackTrace();
}
```
...
String file = "file_example"; // String | file to upload
try {
