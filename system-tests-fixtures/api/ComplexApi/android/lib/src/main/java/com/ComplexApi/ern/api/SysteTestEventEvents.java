...
final class SysteTestEventEvents implements SysteTestEventApi.Events {
    SysteTestEventEvents() {}

    @Override
    public UUID addTestEventEventListener(@NonNull final ElectrodeBridgeEventListener<String> eventListener) {
        return new EventListenerProcessor<>(EVENT_TEST_EVENT, String.class, eventListener).execute();
    }

                @Override
                public ElectrodeBridgeEventListener<ElectrodeBridgeEvent> removeTestEventEventListener(@NonNull final UUID uuid) {
