...
describe('CodegenIgnoreProcessor', function () {
  ...
  function runTest(file, ignoreDefinition) {
    ...
    const f = function () {
      ...
      assert(
        actual === allowed,
        `${file} with definition "${ignoreDefinition}" to be ${
  ...
  describe('Matching', function () {
    ...
    it(
      'A file when matching nested files should ignore.',
      runTest('src/build.sh', '**/build.sh').ignored(),
    );
    it(
      'A file when non-matching should allow.',
      runTest('Build.sh', 'build.sh').allowed(),
    );
    it(
      'A rooted file when matching should ignore.',
      runTest('build.sh', '/build.sh').ignored(),
    );
    it(
      'A rooted file definition when non-matching should allow.',
      runTest('nested/build.sh', '/build.sh').allowed(),
    );
    it(
      'A file when matching exactly should ignore.',
      runTest(
  ...
  describe('Match All', function () {
    ...
    it(
      'A recursive file (1 level) when matching should ignore.',
      runTest('docs/1/somefile.md', 'docs/**').ignored(),
    );
    it(
      'A recursive file (n level) when matching should ignore.',
      runTest('docs/1/2/3/somefile.md', 'docs/**').ignored(),
    );
  });
  ...
  describe('Match Any', function () {
    ...
    it(
      ...
      runTest('docs/1/2/3/somefile.java', 'docs/**/*.java').ignored(),
    );
    it(
      'A recursive file with match-any file name when matching should ignore.',
      runTest('docs/1/2/3/4/somefile.md', 'docs/**/*').ignored(),
    );
    it(
  ...
  describe('Directory matches', function () {
    ...
    it(
      'A directory rule when non-matching should be allowed.',
      runTest('docs/1/Users1/a', 'docs/**/Users/').allowed(),
    );
  });
