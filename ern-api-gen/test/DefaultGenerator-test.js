...
describe('DefaultGenerator', function() {
  ...
  it(
    "should generate: 'uber.json' for 'android'",
    generateObj({
      inputSpec: 'uber.json',
      lang: 'android',
  ...
  it(
    "should generate: 'cookie.json' for 'ERNAndroid'",
    generate('cookie.json', 'ERNAndroid', 'erncookie/ERNAndroid')
  )

  it(
    "should generate: 'petstore.json' for 'android'",
    generate('petstore.json', 'android', 'petstore/android').then(
      compare('petstore/android', 'fixtures/petstore/android')
    )
  )
  ...
  it(
    "should generate: 'baseType.json' for 'ern-android'",
    generate('baseType.json', 'ERNAndroid', 'ern-android-baseType')
  )
  it(
    "should generate: 'isListContainer.json' for 'ern-android'",
    generate(
      'isListContainer.json',
      'ERNAndroid',
      'ern-android-isListContainer'
    )
  )

  it(
    "should generate: 'petstore.json' for 'ern-android'",
    generate('petstore.json', 'ERNAndroid', 'petstore/ern-android')
    //       .then(compare('petstore/ern-android', 'fixtures/petstore/ern-android'))
  )
  it(
    "should generate: 'petstore.json' for 'ern-es6'",
    generate('petstore.json', 'ERNES6', 'petstore/ern-es6')
    //    .then(npm('install', 'petstore/ern-es6'))
  )

  it(
    "should generate: 'petstore.json' for 'ern-es6-classy'",
    generate('petstore.json', 'ERNES6', 'petstore/ern-es6-classy', {
      classy: true,
    })
  ...
  it(
    "should generate: 'petstore.json' for 'ern-swift'",
    generate('petstore.json', 'ERNSwift', 'petstore/ern-swift')
  )

  it(
    "should generate: 'uber.json' for 'es6'",
    generate('uber.json', 'ES6', 'uber/es6')
    //    .then(npm('install', 'uber/es6'))
  )

  it(
    "should generate: 'petstore.json' for 'es6'",
    generate('petstore.json', 'ES6', 'petstore/es6')
    //    .then(npm('install', 'petstore/es6'))
  )

  it(
    "should generate: 'event.json' for 'Swift'",
