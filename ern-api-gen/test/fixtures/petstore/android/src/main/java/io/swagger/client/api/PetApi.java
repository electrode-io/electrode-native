...
public class PetApi {
  ...
  * 
   ...
   * @return void
  */
  public void imageUploaded (Long petId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
      // verify the required parameter 'petId' is set
      if (petId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'petId' when calling imageUploaded",
      new ApiException(400, "Missing the required parameter 'petId' when calling imageUploaded"));
      }

  // create path and map variables
  String path = "/pet/imageUploaded".replaceAll("\\{format\\}","json").replaceAll("\\{" + "petId" + "\\}", apiInvoker.escapeString(petId.toString()));
  ...
  "multipart/form-data"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "EVENT", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return ;
        } else {
           return ;
   ...
   * @param petId ID of pet to update
  */
  public void imageUploaded (Long petId, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "EVENT", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          @Override
          public void onResponse(String localVarResponse) {
              responseListener.onResponse(localVarResponse);
...
formParams.put("status", ApiInvoker.parameterToString(status));
  ...
  * 
   ...
   * @return void
  */
  public void uploadFile (Long petId, String additionalMetadata, String file) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
      // verify the required parameter 'petId' is set
      if (petId == null) {
  ...
  */
  public void uploadFile (Long petId, String additionalMetadata, String file, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
