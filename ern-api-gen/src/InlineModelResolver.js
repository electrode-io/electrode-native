...
export default class InlineModelResolver {
                  ...
                  if (model != null && model instanceof ModelImpl) {
                    ...
                    if (obj.getType() == null || 'object' === obj.getType()) {
                      if (isNotEmptySet(obj.getProperties())) {
                        ...
                        let modelName = this.resolveModelName(
                          obj.getTitle(),
                          bp.getName()
                        )
  ...
  modelFromProperty$io_swagger_models_properties_ObjectProperty$java_lang_String(
    object,
    path
  ) {
    let description = object.getDescription()
  ...
  modelFromProperty$io_swagger_models_properties_MapProperty$java_lang_String(
    object,
    path
  ) {
    let description = object.getDescription()
