...
export default class CodegenModelFactory {
    ...
    static setTypeMapping = function (type, implementation) {
        if (!(implementation.prototype instanceof type.getDefaultImplementation())) {
    ...
    static newInstance = function (type) {
        const classType = CodegenModelFactory.typeMapping.get(type) || type.getDefaultImplementation();
