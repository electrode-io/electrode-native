...
run(`ern cauldron add dependencies ${codePushPackageName}@${codePushVersion} -d ${androidNativeApplicationDescriptor}`)
run(`ern cauldron add dependencies ${codePushPackageName}@${codePushVersion} -d ${iosNativeApplicationDescriptor}`)
